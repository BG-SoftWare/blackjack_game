...
window.DOMHandler = class {
    ...
    Call() {
        if (-1 === this._timerId) {
            const e = Date.now(), t = e - this._lastCallTime, i = this._interval;
            i <= t && this._canRunImmediate ? (this._lastCallTime = e, this._RunCallback()) : this._timerId = self.setTimeout(this._timerCallFunc, Math.max(i - t, 4))
        }
    }
...
};
{
    ...
    window.DOMElementHandler = class extends self.DOMHandler {
        constructor(e, t) {
            super(e, t), this._elementMap = new Map, this._autoAttach = !0, this.AddRuntimeMessageHandlers([["create", e => this._OnCreate(e)], ["destroy", e => this._OnDestroy(e)], ["set-visible", e => this._OnSetVisible(e)], ["update-position", e => this._OnUpdatePosition(e)], ["update-state", e => this._OnUpdateState(e)], ["focus", e => this._OnSetFocus(e)], ["set-css-style", e => this._OnSetCssStyle(e)], ["set-attribute", e => this._OnSetAttribute(e)], ["remove-attribute", e => this._OnRemoveAttribute(e)]]), this.AddDOMElementMessageHandler("get-element", e => e)
        }
        ...
        AddDOMElementMessageHandler(e, s) {
            this.AddRuntimeMessageHandler(e, e => {
                const t = e.elementId, i = this.GetElementById(t);
                return s(i, e)
            })
        }
        ...
        _OnCreate(e) {
            const t = e.elementId, i = this.CreateElement(t, e), s = new y(i),
                n = (this._elementMap.set(t, s), i.style.boxSizing = "border-box", i.style.display = "none", s.SetVisibleFlag(e.isVisible), this._GetFocusElement(i)),
                o = (n.addEventListener("focus", e => this._OnFocus(t)), n.addEventListener("blur", e => this._OnBlur(t)), e.htmlIndex);
            if (s.SetWantHTMLIndex(o), s.SetHTMLZIndex(e.htmlZIndex), this._autoAttach) {
                const a = this.GetRuntimeInterface().GetAvailableHTMLIndex(o),
                    r = (s.SetActualHTMLIndex(a), this.GetRuntimeInterface().GetHTMLWrapElement(a));
                r.appendChild(i)
            }
        }
        ...
        _OnSetVisible(e) {
            if (this._autoAttach) {
                const t = this._elementMap.get(e.elementId), i = t.GetElement();
        ...
        _OnUpdatePosition(e) {
            if (this._autoAttach) {
                const t = this._elementMap.get(e.elementId), i = t.GetElement(), s = this.GetRuntimeInterface(),
                    n = (i.style.left = e.left + "px", i.style.top = e.top + "px", i.style.width = e.width + "px", i.style.height = e.height + "px", e.fontSize),
                ...
                if (a !== t.GetActualHTMLIndex()) {
                    ...
                    d.appendChild(i), t.SetActualHTMLIndex(a), s._UpdateHTMLElementsZOrder()
                }
        ...
        _OnHTMLLayersChanged() {
            if (this._autoAttach) for (const e of this._elementMap.values()) {
                const t = this.GetRuntimeInterface().GetAvailableHTMLIndex(e.GetWantHTMLIndex()),
                    i = e.GetActualHTMLIndex();
                if (-1 !== t && -1 !== i && t !== i) {
                    const s = e.GetElement(), n = (s.remove(), this.GetRuntimeInterface().GetHTMLWrapElement(t));
        ...
        _OnSetCssStyle(e) {
            const t = this.GetElementById(e.elementId), i = e.prop, s = e.val;
...
}
{
    ...
    function AddScript(i) {
        ...
        return s.async = !1, s.type = "module", i.isStringSrc ? new Promise(e => {
            const t = "c3_resolve_" + n;
            ++n, self[t] = e, s.textContent = i.str + `

self["${t}"]();`, document.head.appendChild(s)
        }) : new Promise((e, t) => {
            s.onload = e, s.onerror = t, s.src = i, document.head.appendChild(s)
        })
    }
	...
	});`], {type: "text/javascript"}), i = new Worker(URL.createObjectURL(t), {
                get type() {
                    e = !0
                }
    ...
    async function BlobToString(e) {
        const t = await BlobToArrayBuffer(e), i = new TextDecoder("utf-8");
        return i.decode(t)
    }
    ...
    function BlobToArrayBuffer(s) {
        return new Promise((t, i) => {
            ...
            e.onload = e => t(e.target.result), e.onerror = e => i(e), e.readAsArrayBuffer(s)
        })
    }
    ...
    let r = 0;
    const o0 = [], p0 = (self.runOnStartup = function (e) {
    ...
    window.RuntimeInterface = class P0 {
        ...
        Release() {
            ...
            for (const {canvas: e, htmlWrap: t} of this._canvasLayers) e.remove(), t.remove();
        ...
        * _CanDoAndroidVirtualKeyboardDetection() {
        ...
        async _Init(e) {
            ...
            if ("macos-wkwebview" === this._exportType) this._SendWrapperMessage({type: "ready"}); else if (this.IsAnyWebView2Wrapper() || "linux-cef" === this._exportType) {
            ...
            if ("playable-ad-single-file" === this._exportType && (this._localFileBlobs = self.c3_base64files, this._localFileStrings = {}, await this._ConvertDataUrisToBlobs()), "nwjs" === this._exportType && self.nw) {
                ...
                if (n.on("close", () => self.nw.App.quit()), self.nw.App.manifest["c3-steam-mode"]) {
                    let e = 0;
            ...
            if (e.runtimeBaseUrl) this._runtimeBaseUrl = e.runtimeBaseUrl; else {
                const o = location.origin,
                    a = (this._runtimeBaseUrl = ("null" === o ? "file:///" : o) + location.pathname, this._runtimeBaseUrl.lastIndexOf("/"));
        ...
        async _InitWorker(e, t) {
            const n = e.workerMainUrl,
                i = ("preview" === this._exportType ? (this._worker = new Worker("previewworker.js", {
                    ...
                    const s = e => {
                        this._worker.removeEventListener("message", s), (e.data && "ok" === e.data.type ? t : i)()
                    };
                    ...
                    type: "module",
                    name: "Runtime"
                }), document.createElement("canvas")), s = (i.style.display = "none", i.transferControlToOffscreen()),
            ...
            o.className = "c3htmlwrap", o.setAttribute("interactive", ""), document.body.appendChild(o), this._canvasLayers.push({
                canvas: i,
                htmlWrap: o,
                lastHtmlLayerDomState: {isVisible: !0, opacity: 1, isInteractive: !0}
            }), window.c3canvas = i, self.C3_InsertHTMLPlaceholders && self.C3_InsertHTMLPlaceholders(), this._worker.postMessage(Object.assign(this._GetCommonRuntimeOptions(e), {
                type: "init-runtime",
                isInWorker: !0,
                messagePort: t,
                canvas: s,
        ...
        async _InitDOM(e, t) {
            ...
            if (a) try {
                if (await AddScript(a), "preview" === this._exportType && !globalThis.C3.ScriptsInEvents) throw new Error("scripts in events did not run to completion")
            } catch (e) {
            ...
            this._runtimeDomHandler._EnableWindowResizeEvent(), this._OnBeforeCreateRuntime(), this._localRuntime = self.C3_CreateRuntime(r), await self.C3_InitRuntime(this._localRuntime, r)
        }
        ...
        async CreateWorker(e, t) {
            ...
            const i = new URL(e, location.href), s = location.origin !== i.origin;
            if (s) {
        ...
        GetCssDisplayMode() {
            ...
            const e = this.GetExportType(), t = new Set(["cordova", "nwjs", "macos-wkwebview", "linux-cef"]);
        ...
        _OnUpdateCanvasSize(e) {
            if (!this.IsExportingToVideo()) {
                const t = e.styleWidth + "px", i = e.styleHeight + "px", s = e.marginLeft + "px",
                    n = e.marginTop + "px";
                for (const {
                    canvas: o,
                    htmlWrap: a
                } of this._canvasLayers) o.style.width = t, o.style.height = i, o.style.marginLeft = s, o.style.marginTop = n, a.style.width = t, a.style.height = i, a.style.marginLeft = s, a.style.marginTop = n, this._isFirstSizeUpdate && (o.style.display = "", a.style.display = "");
        ...
        ["_OnSetHTMLLayerCount"](e) {
            const i = e.count, t = e.layersDomState, s = e.immediate, n = e.styleWidth + "px", o = e.styleHeight + "px",
                a = e.marginLeft + "px", r = e.marginTop + "px", d = [], l = [];
            if (i < this._canvasLayers.length) for (; this._canvasLayers.length > i;) {
                const {canvas: h, htmlWrap: c} = this._canvasLayers.pop();
                c.remove(), this._useWorker && !s ? this._pendingRemoveElements.push(h) : h.remove()
            } else if (i > this._canvasLayers.length) for (let e = 0, t = i - this._canvasLayers.length; e < t; ++e) {
                const u = document.createElement("canvas");
                if (u.classList.add("c3overlay"), this._useWorker) {
                    const m = u.transferControlToOffscreen();
                    d.push(m), l.push(m)
                } else d.push(u);
                document.body.appendChild(u);
                const _ = document.createElement("div");
                _.classList.add("c3htmlwrap", "c3overlay"), _.setAttribute("interactive", ""), document.body.appendChild(_), u.style.width = n, u.style.height = o, u.style.marginLeft = a, u.style.marginTop = r, _.style.width = n, _.style.height = o, _.style.marginLeft = a, _.style.marginTop = r, this._runtimeDomHandler._AddDefaultCanvasEventHandlers(u), this._runtimeDomHandler._AddDefaultHTMLWrapEventHandlers(_), this._canvasLayers.push({
                    canvas: u,
                    htmlWrap: _,
                    lastHtmlLayerDomState: {isVisible: !0, opacity: 1, isInteractive: !0}
                })
            ...
            for (const p of this._domHandlers) p instanceof window.DOMElementHandler && p._OnHTMLLayersChanged();
            return this._UpdateHTMLElementsZOrder(), {addedCanvases: d, transferables: l}
        }

        _UpdateHTMLLayerDOMProperties(i) {
            for (let e = 0, t = Math.min(this._canvasLayers.length, i.length); e < t; ++e) {
                const {htmlWrap: s, lastHtmlLayerDomState: n} = this._canvasLayers[e], o = i[e], a = o.isVisible,
                    r = o.opacity, d = o.isInteractive;
                a !== n.isVisible && (s.style.display = a ? "" : "none", n.isVisible = a), r !== n.opacity && (s.style.opacity = 1 === r ? "" : String(r), n.opacity = r), d !== n.isInteractive && (s.style.pointerEvents = d ? "" : "none", d ? s.setAttribute("interactive", "") : s.removeAttribute("interactive"), n.isInteractive = d)
            }
        }
        ...
        _DoUpdateHTMLElementsZOrder() {
            ...
            let e = [];
            for (const o of this._domHandlers) if (o instanceof window.DOMElementHandler) {
                const a = o._GetAllElementStatesForZOrderUpdate();
                a && e.push(...a)
            }
            e.sort((e, t) => {
                const i = e.GetActualHTMLIndex(), s = t.GetActualHTMLIndex();
                if (i !== s) return i - s;
                const n = e.GetHTMLZIndex(), o = t.GetHTMLZIndex();
                return n - o
            });
            let t = 0, i = 0, s = 0, n = e.length;
            for (; s < n; ++s) {
                const r = e[s];
                r.GetActualHTMLIndex() !== t && (this._DoUpdateHTMLElementsZOrderOnHTMLLayer(t, e.slice(i, s)), t = r.GetActualHTMLIndex(), i = s)
            }
        ...
        _DoUpdateHTMLElementsZOrderOnHTMLLayer(e, t) {
            if (!(t.length <= 1 || e >= this._canvasLayers.length)) {
                const s = t.map(e => e.GetElement()), i = new Set(s), n = this.GetHTMLWrapElement(e),
        ...
        PostToRuntimeComponentAsync(e, t, i, s, n) {
            const o = r++, a = new Promise((e, t) => {
                m0.set(o, {resolve: e, reject: t})
            });
        ...
        ["_OnMessageFromRuntime"](e) {
            ...
            if ("result" === t) this._OnResultFromRuntime(e); else if ("runtime-ready" === t) this._OnRuntimeReady(); else if ("alert-error" === t) this._RemoveLoadingMessage(), alert(e.message); else {
        ...
        _OnEventFromRuntime(t) {
            const i = t.component, s = t.handler, n = t.data, o = t.responseId, e = l0.get(i);
            if (e) {
                const a = e.get(s);
                if (a) {
                    let e = null;
                    try {
                        ...
                        return console.error(`Exception in '${i}' handler '${s}':`, t), void (null !== o && this._PostResultToRuntime(o, !1, "" + t))
                    }
                    if (null === o) return e;
                    e && e.then ? e.then(e => this._PostResultToRuntime(o, !0, e)).catch(e => {
                        console.error(`Rejection from '${i}' handler '${s}':`, e), this._PostResultToRuntime(o, !1, "" + e)
                    }) : this._PostResultToRuntime(o, !0, e)
                } else console.warn(`[DOM] No handler '${s}' for component '${i}'`)
        ...
        _OnResultFromRuntime(e) {
            const t = e.responseId, i = e.isOk, s = e.result, n = m0.get(t);
            i ? n.resolve(s) : n.reject(s), m0.delete(t)
        }

        AddRuntimeComponentMessageHandler(e, t, i) {
            let s = l0.get(e);
            if (s || (s = new Map, l0.set(e, s)), s.has(t)) throw new Error(`[DOM] Component '${e}' already has handler '${t}'`);
            s.set(t, i)
        }

        static AddDOMHandlerClass(e) {
            if (k0.includes(e)) throw new Error("DOM handler already added");
            k0.push(e)
        }

        _FindRuntimeDOMHandler() {
            for (const e of this._domHandlers) if ("runtime" === e.GetComponentID()) return void (this._runtimeDomHandler = e);
        ...
        async _WasmDecodeWebMOpus(e) {
            const t = await this.PostToRuntimeComponentAsync("runtime", "opus-decode", {arrayBuffer: e}, null, [e]);
        ...
        async _MaybeGetPlatformSpecificScriptURL(t) {
            ...
            if (this._localFileStrings.hasOwnProperty(t)) return {isStringSrc: !0, str: this._localFileStrings[t]};
        ...
        async _CordovaDoFetchLocalFileAsAsArrayBuffer(e, t, i) {
            try {
                const s = await this.CordovaFetchLocalFile(e), n = await BlobToArrayBuffer(s);
                t(n)
            } catch (e) {
                i(e)
            }
        ...
        async RequestPermissions(e) {
            if ("cordova" === this.GetExportType() && !this.IsiOSCordova()) for (const t of e) {
        ...
        _OnWrapperMessage(e, t) {
            if ("entered-fullscreen" === e) P0._SetWrapperIsFullscreenFlag(!0), this._runtimeDomHandler._OnFullscreenChange(); else if ("exited-fullscreen" === e) P0._SetWrapperIsFullscreenFlag(!1), this._runtimeDomHandler._OnFullscreenChange(); else if ("object" == typeof e) {
                const i = e.type;
                "directory-handles" === i ? this._directoryHandles = t : "wrapper-init-response" === i ? (this._wrapperInitResolve(e), this._wrapperInitResolve = null) : "extension-message" === i ? this.PostToRuntimeComponent("runtime", "wrapper-extension-message", e) : console.warn("Unknown wrapper message: ", e)
        ...
        _SetupDesktopWrapperPolyfills() {
            window.moveTo = (e, t) => {
                this._SendWrapperMessage({type: "set-window-position", windowX: Math.ceil(e), windowY: Math.ceil(t)})
            }, window.resizeTo = (e, t) => {
                this._SendWrapperMessage({
        ...
        _InitWrapper() {
            return new Promise(e => {
                this._wrapperInitResolve = e, this._SendWrapperMessage({type: "wrapper-init"})
            })
        }
        ...
        async _ConvertDataUriToBlobs(t, i) {
            if ("object" == typeof i) this._localFileBlobs[t] = new Blob([i.str], {type: i.type}), this._localFileStrings[t] = i.str; else {
                let e = await this._FetchDataUri(i);
                e = e || this._DataURIToBinaryBlobSync(i), this._localFileBlobs[t] = e
            }
        }
        ...
        _ParseDataURI(e) {
            ...
            const i = e.substring(5, t), s = e.substring(t + 1), n = i.split(";"), o = n[0] || "", a = n[1], r = n[2];
            return {mime_type: o, data: ("base64" === a || "base64" === r ? atob : decodeURIComponent)(s)}
        }

        _BinaryStringToBlob(e, t) {
            let i = e.length, s = i >> 2, n = new Uint8Array(i), o = new Uint32Array(n.buffer, 0, s), a, r;
            for (a = 0, r = 0; a < s; ++a) o[a] = e.charCodeAt(r++) | e.charCodeAt(r++) << 8 | e.charCodeAt(r++) << 16 | e.charCodeAt(r++) << 24;
            let d = 3 & i;
...
}
{
    ...
    const Pd = new Map([["OSLeft", "MetaLeft"], ["OSRight", "MetaRight"]]),
        Qd = {dispatchRuntimeEvent: !0, dispatchUserScriptEvent: !0}, Rd = {dispatchUserScriptEvent: !0},
        Sd = {dispatchRuntimeEvent: !0};

    function AddStyleSheet(s) {
        return new Promise((e, t) => {
            const i = document.createElement("link");
            i.onload = () => e(i), i.onerror = e => t(e), i.rel = "stylesheet", i.href = s, document.head.appendChild(i)
        })
    }
    ...
    function BlobToString(s) {
        return new Promise((t, i) => {
            ...
            e.onload = e => t(e.target.result), e.onerror = e => i(e), e.readAsText(s)
        })
    }
    ...
    let e = !(self.C3_RasterSvgImageBlob = async function (e, t, i, s, n) {
        const o = await BlobToImage(e), a = document.createElement("canvas"),
    ...
    const Wd = "runtime", Xd = class extends self.DOMHandler {
        ...
        _OnBeforeStartTicking() {
            ...
            }, 1e3), "cordova" === this._iRuntime.GetExportType() ? (document.addEventListener("pause", () => this._OnVisibilityChange(!0)), document.addEventListener("resume", () => this._OnVisibilityChange(!1))) : document.addEventListener("visibilitychange", () => this._OnVisibilityChange("hidden" === document.visibilityState)), this._pageVisibilityIsHidden = !("hidden" !== document.visibilityState && !e), {isSuspended: this._pageVisibilityIsHidden}
        }

        Attach() {
            window.addEventListener("focus", () => this._PostRuntimeEvent("window-focus")), window.addEventListener("blur", () => {
                this._PostRuntimeEvent("window-blur", {parentHasFocus: ParentHasFocus()}), this._mousePointerLastButtons = 0
        ...
        _OnAndroidVirtualKeyboardChange(t, i) {
            if (document.body.style.position = "", document.body.style.overflow = "", document.body.style.transform = "", (this._vkTranslateYOffset = 0) < i) {
                const s = document.activeElement;
                if (s) {
                    const n = s.getBoundingClientRect(), o = (n.top + n.bottom) / 2, a = (t - i) / 2;
                    let e = o - a;
                    0 < (e = (e = i < e ? i : e) < 0 ? 0 : e) && (document.body.style.position = "absolute", document.body.style.overflow = "visible", document.body.style.transform = `translateY(${-e}px)`, this._vkTranslateYOffset = e)
                }
            }
        }
        ...
        _OnWindowResize() {
            if (!this._isExportToVideo && this._enableWindowResizeEvent) {
                const e = this._GetWindowInnerWidth(), t = this._GetWindowInnerHeight();
                if (this._iRuntime.IsAndroidWebView()) {
                    if (this._enableAndroidVKDetection) {
                        ...
                        if (i && this._lastWindowWidth === e && t < this._lastWindowHeight) return this._virtualKeyboardHeight = this._lastWindowHeight - t, void this._OnAndroidVirtualKeyboardChange(this._lastWindowHeight, this._virtualKeyboardHeight);
        ...
        _OnSimulatedResize(e, t, i) {
            const s = this._GetWindowInnerWidth(), n = this._GetWindowInnerHeight();
        ...
        _TrySetTargetOrientation() {
            ...
            if (screen.orientation && screen.orientation.lock) screen.orientation.lock(t).catch(e => console.warn("[Construct] Failed to lock orientation: ", e)); else try {
                let e = !1;
        ...
        _OnPointerEvent(t, i) {
            if (!this._isExportToVideo) {
                let e = 0;
                "mouse" === i.pointerType && (e = this._mousePointerLastButtons), this._PostToRuntimeMaybeSync(t, {
                ...
                }, Qd), "mouse" === i.pointerType && (this._mousePointerLastButtons = i.buttons)
            }
        }
        ...
        _OnTouchEvent(i, s) {
            if (!this._isExportToVideo) for (let e = 0, t = s.changedTouches.length; e < t; ++e) {
        ...
        _OnInvokeDownload(e) {
            const t = e.url, i = e.filename, s = document.createElement("a"), n = document.body;
        ...
        async _OnRasterSvgImage(e) {
            const t = e.blob, i = e.imageWidth, s = e.imageHeight, n = e.surfaceWidth, o = e.surfaceHeight,
                a = e.imageBitmapOpts, r = await self.C3_RasterSvgImageBlob(t, i, s, n, o);
            let d;
            return {imageBitmap: d = a ? await createImageBitmap(r, a) : await createImageBitmap(r), transferables: [d]}
        }
        ...
        _PlayPendingMedia() {
            ...
            if (this._mediaPendingPlay.clear(), !this._isSilent) for (const t of e) {
                const i = t.play();
                i && i.catch(e => {
        ...
        _InvokeFunctionFromJS(e, t) {
            return this.PostToRuntimeAsync("js-invoke-function", {name: e, params: t})
        }

        _OnScriptCreateWorker(e) {
            const t = e.url, i = e.opts, s = e.port2, n = new Worker(t, i);
        ...
        _OnScreenReaderTextEvent(e) {
            ...
            if ("create" === t) {
                ...
                i.id = "c3-sr-" + e.id, i.textContent = e.text, this._screenReaderTextWrap.appendChild(i)
            } else if ("update" === t) {
        ...
        _OnExportedToImageSequence(e) {
            window.c3_postToMessagePort({type: "exported-image-sequence", blobArr: e.blobArr, time: e.time, gif: e.gif})
        }
    };
    ...
    self.JobSchedulerDOM = class {
        ...
        async Init() {
            ...
            const e = this._runtimeInterface.GetScriptFolder() + Cf,
                t = (this._dispatchWorker = await this._runtimeInterface.CreateWorker(e, {name: "DispatchWorker"}), new MessageChannel);
        ...
        async _CreateJobWorker() {
            const e = this._jobWorkers.length, t = this._runtimeInterface.GetScriptFolder() + Df,
                i = await this._runtimeInterface.CreateWorker(t, {name: "JobWorker" + e}), s = new MessageChannel,
...
{
    const Mf = "touch", Nf = class extends self.DOMHandler {
        constructor(e) {
            super(e, Mf), this.AddRuntimeMessageHandler("request-permission", e => this._OnRequestPermission(e))
        }
    ...
    self.AudioDOMHandler = class extends self.DOMHandler {
        ...
        async _CreateAudioContext(e) {
            if (e.usePlayMusicAsSoundWorkaround && (this._playMusicAsSound = !0), this._timeScaleMode = e.timeScaleMode, this._panningModel = ["equalpower", "HRTF", "soundfield"][e.panningModel], this._distanceModel = ["linear", "inverse", "exponential"][e.distanceModel], this._refDistance = e.refDistance, this._maxDistance = e.maxDistance, this._rolloffFactor = e.rolloffFactor, this._iRuntime.IsExportingToVideo()) this._playMusicAsSound = !0, this._audioContext = new OfflineAudioContext({
                ...
                if (this.SupportsWebMOpus() || (i.sampleRate = 48e3), "undefined" != typeof AudioContext) this._audioContext = new AudioContext(i); else {
                ...
                this._AttachUnblockEvents(), this._audioContext.onstatechange = () => {
                    "running" !== this._audioContext.state && this._AttachUnblockEvents(), this.PostToRuntime("audiocontext-state", {audioContextState: this._audioContext.state})
                }
            }
        ...
        _UnblockAudioContext() {
            if (!this._hasUnblocked) {
                const e = this._audioContext,
                    t = ("suspended" === e.state && e.resume && e.resume(), e.createBuffer(1, 220, 22050)),
        ...
        _MatchTagLists(t, e) {
            for (const i of e) {
                let e = !1;
                for (const s of t) if (self.AudioDOMHandler.EqualsNoCase(s, i)) {
                    e = !0;
                    break
                }
                if (!e) return !1
        ...
        DecodeAudioData(i, e) {
            return e ? this._iRuntime._WasmDecodeWebMOpus(i).then(e => {
                const t = this._audioContext.createBuffer(1, e.length, 48e3), i = t.getChannelData(0);
                return i.set(e), t
            }) : new Promise((e, t) => {
        ...
        * audioInstancesMatchingTags(e) {
            if (0 < e.length) for (const t of this._audioInstances) this._MatchTagLists(t.GetTags(), e) && (yield t); else this._lastAudioInstance && !this._lastAudioInstance.HasEnded() && (yield this._lastAudioInstance)
        }

        * audioInstancesByEffectTag(e) {
            if (e) for (const t of this._audioInstances) self.AudioDOMHandler.EqualsNoCase(t.GetEffectTag(), e) && (yield t); else this._lastAudioInstance && !this._lastAudioInstance.HasEnded() && (yield this._lastAudioInstance)
        }

        async _GetAudioBuffer(e, t, i, s, n) {
            for (const a of this._audioBuffers) if (a.GetUrl() === t) return await a.Load(), a;
            if (n) return null;
            ...
            return this._audioBuffers.push(o), await o.Load(), this._loadedAudioUrls.has(e) || (this.PostToRuntime("buffer-metadata", {
                originalUrl: e,
        ...
        async _GetAudioInstance(e, t, i, s, n) {
            for (const r of this._audioInstances) if (r.GetUrl() === t && (r.CanBeRecycled() || n)) return r.SetTags(s), r;
            const o = await this._GetAudioBuffer(e, t, i, n), a = o.CreateInstance(s);
        ...
        _AddPendingTags(e) {
            ...
            if (!s) {
                ...
                s = {pendingCount: 0, promise: n, resolve: t}, this._pendingTags.set(i, s)
            }
            s.pendingCount++
        }

        _RemovePendingTags(e) {
            const t = e.join(" "), i = this._pendingTags.get(t);
            if (!i) throw new Error("expected pending tag");
            i.pendingCount--, 0 === i.pendingCount && (i.resolve(), this._pendingTags.delete(t))
        }

        TagsReady(e) {
            const t = (0 === e.length ? this._lastPlayedTags : e).join(" "), i = this._pendingTags.get(t);
            return i ? i.promise : Promise.resolve()
        }

        _MaybeStartTicking() {
            if (0 < this._analysers.size) this._StartTicking(); else for (const e of this._audioInstances) if (e.IsActive()) return void this._StartTicking()
        }
        ...
        async _Play(e) {
            const t = e.originalUrl, i = e.url, s = e.type, n = e.isMusic, o = e.tags, a = e.isLooping, r = e.vol,
                d = e.pos, l = e.panning, h = e.stereoPan;
            let c = e.off;
            if (0 < c && !e.trueClock) if (this._audioContext.getOutputTimestamp) {
        ...
        _SetPaused(e) {
            const t = e.tags, i = e.paused;
            for (const s of this.audioInstancesMatchingTags(t)) i ? s.Pause() : s.Resume();
            this._MaybeStartTicking()
        }

        _SetVolume(e) {
            const t = e.tags, i = e.vol;
            for (const s of this.audioInstancesMatchingTags(t)) s.SetVolume(i)
        }

        _SetStereoPan(e) {
            const t = e.tags, i = e.p;
            for (const s of this.audioInstancesMatchingTags(t)) s.SetStereoPannerEnabled(!0), s.SetStereoPan(i)
        }

        async _FadeVolume(e) {
            const t = e.tags, i = e.vol, s = e.duration, n = e.stopOnEnd;
        ...
        async _Unload(e) {
            const t = e.url, i = e.type, s = e.isMusic, n = await this._GetAudioBuffer("", t, i, s, !0);
            if (n) {
                n.Release();
        ...
        _OnTick(e) {
            if (this._timeScale = e.timeScale, this._gameTime = e.gameTime, this._lastTickCount = e.tickCount, 0 !== this._timeScaleMode) for (const s of this._audioInstances) s._UpdatePlaybackRate();
            const t = e.listenerPos,
                i = (!t || this._lastListenerPos[0] === t[0] && this._lastListenerPos[1] === t[1] && this._lastListenerPos[2] === t[2] || (this._lastListenerPos[0] = t[0], this._lastListenerPos[1] = t[1], this._lastListenerPos[2] = t[2], this._audioContext.listener.setPosition(t[0], t[1], t[2])), e.listenerOrientation);
        ...
        async _AddEffect(e) {
            const t = e.type, i = e.hasOwnProperty("tags") ? e.tags : [e.tag], s = e.params;
            let n, o;
        ...
        _SetEffectParam(e) {
            const t = e.tags, i = e.index, s = e.param, n = e.value, o = e.ramp, a = e.time;
            for (const r of t) {
        ...
        _RemoveEffects(e) {
            const t = e.tags;
            for (const i of t) {
                const s = i.toLowerCase(), n = this._effects.get(s);
        ...
        _DoPostUpdatedFxState() {
            ...
            this.PostToRuntime("fxstate", {fxstate: e}), this._isPendingPostFxState = !1
        }
        ...
        async _OnLoadState(e) {
            ...
            if (3 !== t) {
                const o = [];
                for (const a of this._audioInstances) a.IsMusic() && 1 === t || !a.IsMusic() && 2 === t ? o.push(a) : a.Release();
            ...
            const i = e.listenerPos,
                s = (this._lastListenerPos[0] = i[0], this._lastListenerPos[1] = i[1], this._lastListenerPos[2] = i[2], this._audioContext.listener.setPosition(i[0], i[1], i[2]), e.listenerOrientation);
            if (Array.isArray(s)) {
            ...
            const n = [];
            for (const l of Object.values(e.effects)) n.push(Promise.all(l.map(e => this._AddEffect(e))));
        ...
        async _LoadAudioInstance(t, i) {
            if (3 !== i) {
                const s = t.bufferOriginalUrl, n = t.bufferUrl, o = t.bufferType, a = t.isMusic, r = t.tags,
                    d = t.isLooping, l = t.volume, h = t.playbackTime;
                if ((!a || 1 !== i) && (a || 2 !== i)) {
                    let e = null;
                    try {
                    ...
                    e.LoadPanState(t.pan), e.LoadStereoPanState(t.stereoPan), e.Play(d, l, h, 0), t.isPlaying || e.Pause(), e._LoadAdditionalState(t)
                }
            }
        }
        ...
        async _OnOfflineRenderAudio(e) {
            try {
                const t = e.time, i = this._audioContext.suspend(t);
...
self.C3AudioBuffer = class {
    ...
    async _Fetch() {
        ...
        if ("cordova" === e.GetExportType() && e.IsRelativeURL(this._url) && e.IsFileProtocol()) this._audioData = await e.CordovaFetchLocalFileAsArrayBuffer(this._url); else if ("playable-ad-single-file" === e.GetExportType() && e.IsRelativeURL(this._url)) {
...
};
{
    ...
    self.C3AudioInstance = class {
        ...
        SetPanXYZA(e, t, i, s) {
            if (this._isPannerEnabled) {
                const n = this._pannerPosition, o = this._pannerOrientation, a = Math.cos(s), r = Math.sin(s);
        ...
        LoadPanState(e) {
            if (e) {
                ...
                const t = this._pannerNode, i = e.pos,
                    s = (this._pannerPosition[0] = i[0], this._pannerPosition[1] = i[1], this._pannerPosition[2] = i[2], e.orient);
...
self.C3Html5AudioInstance = class extends self.C3AudioInstance {
    ...
    GetPlaybackTime() {
        let e = 0;
        return e = this._isPaused ? this._resumePosition : this._playFromSeekPos + (this.GetCurrentTime() - this._playStartTime) * this._playbackRate, this._isLooping ? e : Math.min(e, this.GetDuration())
    }
...
};
{
    class _8 {
        ...
        SetAudioParam(e, t, i, s) {
            if (e.cancelScheduledValues(0), 0 === s) e.value = t; else {
    ...
    self.C3AudioFilterFX = class extends _8 {
        ...
        _GenerateColortouchCurve(i, s) {
            ...
            for (let t = 0; t < n; ++t) {
                let e = t / n;
                e = this._Shape(e, i, s), this._curve[n + t] = e, this._curve[n - t - 1] = -e
            }
        }

        _Shape(e, t, i) {
            const s = 1.05 * i * t, n = s - t, o = e < 0 ? -1 : 1, a = e < 0 ? -e : e;
...
{
    const Ok = "localstorage", Pk = class extends self.DOMHandler {
        constructor(e) {
            super(e, Ok), this.AddRuntimeMessageHandlers([["init", () => this._Init()], ["request-persistent", () => this._OnRequestPersistent()]])
        }
        ...
        async _Init() {
            ...
            try {
                ...
                t = !1, console.warn("[Construct] Error checking storage persisted state: ", e)
            }
        ...
        async _OnRequestPersistent() {
            try {
                ...
                return console.error("[Construct] Error requesting persistent storage: ", e), {isOk: !1}
            }
        }
    };
    self.RuntimeInterface.AddDOMHandlerClass(Pk)
}
{
    let t = null, i = null;
    ...
    window.addEventListener("beforeinstallprompt", e => (e.preventDefault(), t = e, i && i._OnBeforeInstallPrompt(), !1));
    const Xk = "browser", Yk = class extends self.DOMHandler {
        constructor(e) {
            super(e, Xk), this._exportType = "", this.AddRuntimeMessageHandlers([["get-initial-state", e => this._OnGetInitialState(e)], ["ready-for-sw-messages", () => this._OnReadyForSWMessages()], ["alert", e => this._OnAlert(e)], ["close", () => this._OnClose()], ["set-focus", e => this._OnSetFocus(e)], ["vibrate", e => this._OnVibrate(e)], ["lock-orientation", e => this._OnLockOrientation(e)], ["unlock-orientation", () => this._OnUnlockOrientation()], ["navigate", e => this._OnNavigate(e)], ["request-fullscreen", e => this._OnRequestFullscreen(e)], ["exit-fullscreen", () => this._OnExitFullscreen()], ["set-hash", e => this._OnSetHash(e)], ["set-document-css-style", e => this._OnSetDocumentCSSStyle(e)], ["get-document-css-style", e => this._OnGetDocumentCSSStyle(e)], ["set-window-size", e => this._OnSetWindowSize(e)], ["set-window-position", e => this._OnSetWindowPosition(e)], ["request-install", () => this._OnRequestInstall()], ["set-warn-on-close", e => this._OnSetWarnOnClose(e)]]), window.addEventListener("online", () => this._OnOnlineStateChanged(!0)), window.addEventListener("offline", () => this._OnOnlineStateChanged(!1)), window.addEventListener("hashchange", () => this._OnHashChange()), this._beforeunload_handler = e => e.preventDefault(), document.addEventListener("backbutton", () => this._OnCordovaBackButton())
        }

        Attach() {
            t ? this._OnBeforeInstallPrompt() : i = this, window.addEventListener("appinstalled", () => this._OnAppInstalled())
        }
        ...
        async _OnRequestInstall() {
            ...
            try {
                ...
                return console.error("[Construct] Requesting install failed: ", e), {result: "failed"}
            }
        }
        ...
        _OnNavigate(e) {
            const t = e.type;
            if ("back" === t) navigator.app && navigator.app.backHistory ? navigator.app.backHistory() : window.history.back(); else if ("forward" === t) window.history.forward(); else if ("reload" === t) location.reload(); else if ("url" === t) {
                const i = e.url, s = e.target, n = e.exportType;
        ...
        _OnRequestFullscreen(t) {
            if (this._iRuntime.IsAnyWebView2Wrapper() || "macos-wkwebview" === this._exportType || "linux-cef" === this._exportType) self.RuntimeInterface._SetWrapperIsFullscreenFlag(!0), this._iRuntime._SendWrapperMessage({
                ...
                const i = {navigationUI: "auto"}, s = t.navUI,
                    n = (1 === s ? i.navigationUI = "hide" : 2 === s && (i.navigationUI = "show"), document.documentElement);
                let e;
                n.requestFullscreen ? e = n.requestFullscreen(i) : n.mozRequestFullScreen ? e = n.mozRequestFullScreen(i) : n.msRequestFullscreen ? e = n.msRequestFullscreen(i) : n.webkitRequestFullScreen && (e = void 0 !== Element.ALLOW_KEYBOARD_INPUT ? n.webkitRequestFullScreen(Element.ALLOW_KEYBOARD_INPUT) : n.webkitRequestFullScreen()), e instanceof Promise && e.catch(noop)
            }
        }
        ...
        _OnSetDocumentCSSStyle(e) {
            const t = e.prop, i = e.value, s = e.selector, n = e["is-all"];
            try {
                const o = elemsForSelector(s, n);
                for (const e of o) t.startsWith("--") ? e.style.setProperty(t, i) : e.style[t] = i
            } catch (e) {
        ...
        _OnGetDocumentCSSStyle(e) {
            ...
            try {
                ...
                return console.warn("[Browser] Failed to get style: ", e), {isOk: !1}
            }
        }
    ...
    self.RuntimeInterface.AddDOMHandlerClass(Yk)
}
{
    const gm = "text-input";
    ...
    const hm = class extends self.DOMElementHandler {
        constructor(e) {
            super(e, gm), this.AddDOMElementMessageHandler("scroll-to-bottom", e => this._OnScrollToBottom(e))
        }

        CreateElement(t, e) {
            let i;
            const s = e.type;
            return "textarea" === s ? (i = document.createElement("textarea")).style.resize = "none" : (i = document.createElement("input")).type = s, i.style.position = "absolute", i.autocomplete = "off", i.addEventListener("pointerdown", StopPropagation), i.addEventListener("pointermove", StopPropagation), i.addEventListener("pointerrawupdate", StopPropagation), i.addEventListener("pointerup", StopPropagation), i.addEventListener("mousedown", StopPropagation), i.addEventListener("mouseup", StopPropagation), i.addEventListener("keydown", StopKeyPropagation), i.addEventListener("keyup", StopKeyPropagation), i.addEventListener("click", e => {
                e.stopPropagation(), this._PostToRuntimeElementMaybeSync("click", t)
            }), i.addEventListener("dblclick", e => {
                e.stopPropagation(), this._PostToRuntimeElementMaybeSync("dblclick", t)
            }), i.addEventListener("input", () => this.PostToRuntimeElement("change", t, {text: i.value})), e.id && (i.id = e.id), e.className && (i.className = e.className), this.UpdateState(i, e), i
        }
    ...
    self.RuntimeInterface.AddDOMHandlerClass(hm)
}
